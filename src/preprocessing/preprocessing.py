...
parser.add_argument('--meals_data', type=str, default='../../data/data_original/data_files'
                                                      '/RYSA_ruokapvkirjat_0kk_1vk_nestelista_6kk_12kk_25032020_password_protected.xlsx',
                    help="Path to meals data.")
parser.add_argument('--glucose_data', type=str, default='../../data/data_original/data_files/Operation/Operation/',
...
if __name__ == "__main__":
    ...
    train_data_save(df_sliced, args.processed_data + args.period + '/')
    test_data_save(df_sliced_test, args.processed_data + args.period + '/')

    # Combine train and test data
    combine_train_test(args.processed_data + args.period + '/')
