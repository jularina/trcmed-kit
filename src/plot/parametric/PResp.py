...
parser.add_argument('--model', type=int, default=2, help="Index of running model.")
parser.add_argument('--modelname', type=str, default='P-Resp', help="Index of running model.")
parser.add_argument('--modelstr', type=str, default='model2',
                    help="Model name.")
