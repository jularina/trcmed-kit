...
def simulate_artificial_data():
    ...
    glucose_num = [230, 250, 190, 187, 225, 280, 215, 300, 235, 270]
    meals = [np.array([[8.0,10,7],[12.5,12,3],[17.5,8,8],[20.0,8,5],[28.0,10,10],[32.5,9,2]]),
             np.array(
                 [[6.5, 12, 7], [12.0, 11, 3], [16.0, 8, 8], [20.0, 8, 5], [28.0, 7, 15], [32.5, 11, 6]]),
             np.array(
